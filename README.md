...
- **YARP (Yet Another Reverse Proxy)** — маршрутизация запросов через GatewayService, проксирование к бизнес-сервисам
...
Каждый сервис можно запускать локально через Visual Studio или `dotnet run`, используя соответствующие `.env.development` файлы.

#### 🗂 Список локальных адресов

| Сервис         | HTTP                          | HTTPS                          | Gateway (порт `5096`)          |
|----------------|-------------------------------|--------------------------------|--------------------------------|
| AuthService     | http://localhost:5121/        | https://localhost:7036/        | http://localhost:5096/api/auth/     |
| CartService     | http://localhost:5217/        | https://localhost:7071/        | http://localhost:5096/api/cart/     |
| CatalogService  | http://localhost:5018/        | https://localhost:7159/        | http://localhost:5096/api/catalog/  |
| OrderService    | http://localhost:5127/        | https://localhost:7176/        | http://localhost:5096/api/orders/   |
| PaymentService  | http://localhost:5283/        | https://localhost:7177/        | http://localhost:5096/api/payments/ |
| GatewayService  | http://localhost:5096/        | https://localhost:7215/        |   —                              |

#### 📦 Сторонние сервисы (локально)
...
> 💡 Убедитесь, что переменные окружения в `.env.development` соответствуют локальным портам и конфигурации.
